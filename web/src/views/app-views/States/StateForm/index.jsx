...
import {STATE_LIST } from '../../../../constants/ApiConstants';
...
const StateForm = props => {
	...
	const {data: state, isLoading, callback: getStates} = useAxiosCallback()
					...
					addState({
						...
						success: (res)=>{
							if(res){
								...
								history.push(`${APP_PREFIX_PATH}/states`)
							}
				...
				<PageHeaderAlt className="border-bottom" overlap>
					<div className="container">
						<Flex className="py-2" mobileFlex={false} justifyContent="between" alignItems="end">
							<h2 className="mb-3">{mode === 'ADD' ? 'Add New State' : `Edit State`} </h2>
							<div className="mb-3">
