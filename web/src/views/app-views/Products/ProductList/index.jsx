...
const ProductList = ({match, ...props}) => {
	...
	const tableColumns = [
		...
		{
			title: 'Description',
			dataIndex: 'sort_description',
			sorter: (a, b) => utils.antdTableSorter(a, b, 'sort_description')
		},
		// {
		// 	title: 'Stock',
		// 	dataIndex: 'stock',
			...
			render: is_custom => (
				<Flex alignItems="center">
					{is_custom ?
						...
						:
						<>
							<Badge status="error" /><span>Non Customisable</span>
						</>}</Flex>
			),
			sorter: (a, b) => utils.antdTableSorter(a, b, 'is_custom')
		},
