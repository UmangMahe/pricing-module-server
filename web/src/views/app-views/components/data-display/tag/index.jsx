      ...
      <React.Fragment>
        <Row gutter={16} type="flex">
          <Col sm={24} md={24} lg={12}>
            ...
            <DemoCard code={ControlMd}>
              <Control />
            </DemoCard>
            <DemoCard code={HotTagsMd}>
              <HotTags />
            </DemoCard>
            <DemoCard code={AnimationMd}>
              <Animation />
            </DemoCard>
          </Col>
          <Col sm={24} md={24} lg={12}>
            <DemoCard code={ColorfulMd}>
              <Colorful />
            </DemoCard>
            <DemoCard code={CheckableMd}>
              <Checkable />
            </DemoCard>
            <DemoCard code={ControlledMd}>
              <Controlled />
            </DemoCard>
            <DemoCard code={StatusMd}>
              <Status />
            </DemoCard>
          </Col>
        </Row>
