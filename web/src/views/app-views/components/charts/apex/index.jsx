      ...
      <React.Fragment>
        <Row gutter={16} type="flex">
          <Col sm={24} md={24} lg={12}>
            <DemoCard code={BasicLineMd}>
              <BasicLine />
            </DemoCard>
            <DemoCard code={BasicAreaMd}>
              <BasicArea />
            </DemoCard>
            <DemoCard code={BasicColumnMd}>
              <BasicColumn />
            </DemoCard>
            <DemoCard code={BasicBarMd}>
              <BasicBar />
            </DemoCard>
            <DemoCard code={PieMd}>
              <Pie />
          ...
          <Col sm={24} md={24} lg={12}>
            <DemoCard code={DashedLineMd}>
              <DashedLine />
            </DemoCard>
            <DemoCard code={SplineAreaMd}>
              <SplineArea />
            </DemoCard>
            <DemoCard code={StackedColumnMd}>
              <StackedColumn />
            </DemoCard>
            <DemoCard code={GroupedBarMd}>
              <GroupedBar />
            </DemoCard>
            <DemoCard code={DonutMd}>
              <Donut />
            </DemoCard>
          </Col>
        </Row>
