      ...
      <React.Fragment>
        <Row gutter={16} type="flex">
          <Col sm={24} md={24} lg={12}>
            ...
            <DemoCard code={IconSliderMd}>
              <IconSlider />
            </DemoCard>
            <DemoCard code={EventMd}>
              <Event />
            </DemoCard>
            <DemoCard code={VerticalMd}>
              <Vertical />
            </DemoCard>
            <DemoCard code={ReverseMd}>
              <Reverse />
            </DemoCard>
          </Col>
          <Col sm={24} md={24} lg={12}>
            <DemoCard code={InputNumberMd}>
              <InputNumber />
            </DemoCard>
            <DemoCard code={TipFormatterMd}>
              <TipFormatter />
            </DemoCard>
            <DemoCard code={MarkMd}>
              <Mark />
            </DemoCard>
            <DemoCard code={ShowTooltipMd}>
              <ShowTooltip />
            </DemoCard>
          </Col>
        </Row>
