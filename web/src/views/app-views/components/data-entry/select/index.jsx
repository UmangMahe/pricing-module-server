      ...
      <React.Fragment>
        <Row gutter={16} type="flex">
          <Col sm={24} md={24} lg={12}>
            ...
            <DemoCard code={MultipleMd}>
              <Multiple />
            </DemoCard>
            <DemoCard code={OptionLabelPropMd}>
              <OptionLabelProp />
            </DemoCard>
            <DemoCard code={OptgroupMd}>
              <Optgroup />
            </DemoCard>
            <DemoCard code={SearchBoxMd}>
              <SearchBox />
            </DemoCard>
            <DemoCard code={AutomaticTokenizationMd}>
              <AutomaticTokenization />
            </DemoCard>
            <DemoCard code={CustomDropdownMenuMd}>
              <CustomDropdownMenu />
            </DemoCard>
            <DemoCard code={BigDataMd}>
              <BigData />
            </DemoCard>
            <DemoCard code={CustomTagRenderMd}>
              <CustomTagRender />
            </DemoCard>
          </Col>
          <Col sm={24} md={24} lg={12}>
            <DemoCard code={SearchMd}>
              <Search />
            </DemoCard>
            <DemoCard code={SizeMd}>
              <Size />
            </DemoCard>
            <DemoCard code={TagsMd}>
              <Tags />
            </DemoCard>
            <DemoCard code={CoordinateMd}>
              <Coordinate />
            </DemoCard>
            <DemoCard code={LabelInValueMd}>
              <LabelInValue />
            </DemoCard>
            <DemoCard code={SelectUsersMd}>
              <SelectUsers />
            </DemoCard>
            <DemoCard code={HideSelectedMd}>
              <HideSelected />
            </DemoCard>
